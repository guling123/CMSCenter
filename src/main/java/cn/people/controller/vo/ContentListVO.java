...
public class ContentListVO implements Serializable
{
    ...
    {
        return "ContentListVO{" + "id='" + id + '\'' + ", siteId='" + siteId + '\''
               + ", sourceUrl='" + sourceUrl + '\'' + ", title='" + title + '\'' + ", dtype="
               + dtype + ", sourceName='" + sourceName + '\'' + ", createName='" + createName
               + '\'' + ", createTime=" + createTime + ", dstatus=" + dstatus + ", sendTime="
               + sendTime + '}';
    }
}
