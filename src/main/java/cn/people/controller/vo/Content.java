...
public class Content extends BaseEntity {
    ...
    private Date createtid;

    @ApiModelProperty(value = "创建人姓名")
    @TableField("createtname")
    private Date createtname;
    ...
    public Date getCreatetid()
    {
        return createtid;
    }

    public void setCreatetid(Date createtid)
    {
        this.createtid = createtid;
    }

    public Date getCreatetname()
    {
        return createtname;
    }

    public void setCreatetname(Date createtname)
    {
